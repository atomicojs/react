...
export type Props<Element extends AtomicoELement> = HTMLAttributes<HTMLElement> & {
    style?: CSSProperties & {
        [key: `--${string}`]: string;
    };
    ref?: Ref<HTMLElement>;
...
export type Component<Element extends AtomicoELement> = (props: Props<Element>) => ReactElement;
